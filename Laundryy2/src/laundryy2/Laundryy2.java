 ...
 */
public class Laundryy2 {//konstruktor
 static Client client = new Client();//membuat objek baru dari class Client
    static Petugas petugas = new Petugas();//new membuat objek baru
